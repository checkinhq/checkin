...
type AuthenticationService struct {
	service user.AuthenticationService
...
func NewAuthenticationService(service user.AuthenticationService, opts ...AuthenticationServiceOption) *AuthenticationService {
