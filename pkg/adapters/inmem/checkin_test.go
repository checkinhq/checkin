...
import (
	...
	"github.com/checkinhq/checkin/pkg/adapters/inmem"
...
func newCheckin(t *testing.T) *checkin.Checkin {
	c := &checkin.Checkin{
		ID:     1,
		UserID: 1,
...
func saveCheckin(t *testing.T, db *memdb.MemDB, c *checkin.Checkin) {
	txn := db.Txn(true)
