...
import (
	...
	"github.com/checkinhq/checkin/pkg/domain/checkin"
				...
				"checkin": {
					...
					Indexer: &memdb.CompoundIndex{
						Indexes: []memdb.Indexer{
							&internal.IntFieldIndex{Field: "ID"},
...
func NewCheckinRepository(opts ...CheckinRepositoryOption) checkin.Repository {
...
func (r *checkinRepository) Store(c *checkin.Checkin) error {
	txn := r.db.Txn(true)
